        ...
        <CardContent className="pt-6">
          ...
          <div className="max-w-3xl mx-auto p-4 bg-muted/30 rounded-lg text-xs">
            ...
            <section className="terms-section">
              ...
              <p>
                Our Buy 1 Get 1 offer is structured to provide maximum value at
                this price range. Product quality is aligned with the offer
                pricing.
              </p>

              <p>
                Expectations of original brand products or high-end premium
                replicas are not applicable, as those belong to a significantly
